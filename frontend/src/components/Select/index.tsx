...
export function Select<T>({
    ...
    return (
        <div
            ref={outerRef}
            className={
                'min-w-[0] relative max-width-[none] rounded-2xl ' +
                (className ?? '')
            }
        >
            <button
            ...
            {open && (
                <div
                    className={
                        (top ? 'pb-1' : 'py-1') +
                        ' overflow-hidden z-10 border-2 border-solid flex flex-col text-left min-w-min max-width-[none] absolute bg-white rounded-xl top-[100%] left-0 right-0 special-scroll-thin'
                    }
                    ref={optionsRef}
                >
                    {top ? (
                        topButton ? (
                            <button
                                ...
                                className={
                                    'cursor-pointer px-3 py-2 bg-[#D8B4FE] text-white ' +
                                    topClassname
                                }
                            >
                                {typeof top === 'string'
                            ...
                            <div
                                className={
                                    'px-3 py-2 bg-[#D8B4FE] text-white ' +
                                    topClassname
                                }
                            >
                                {typeof top === 'string'
                    ...
                    {options.length > 0 ? (
                        ...
                        <div className="p-2 text-center text-[16px] text-[#616161]">
                            {emptyLabel ?? 'Пусто'}
                        </div>
                    )}
                </div>
