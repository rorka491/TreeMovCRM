												...
												<td key={dayIdx} className="border px-2 py-1 align-top">
													{cell ? (
														<>
															...
															<br />
															Преп: {cell.teacher?.employer?.surname} {cell.teacher?.employer?.name} {cell.teacher?.employer?.patronymic}
															<br />
															{cell.classroom ? (
																<>
																	Ауд: {typeof cell.classroom.title === "string" ? cell.classroom.title : JSON.stringify(cell.classroom.title)}, этаж {cell.classroom.floor}, корпус {cell.classroom.building}
																</>
															) : (
																"-"
															)}
