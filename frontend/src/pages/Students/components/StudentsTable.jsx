                ...
                {loaded
                    ? students.map((student) => (
                          <tr key={student.id}>
                              ...
                              <td className="relative border-y-2 py-2 border-r-2 pr-3 rounded-r-xl">
                                  <button onClick={() => setPopupOpen(student.id)} className="w-10 h-5 rounded-xl bg-white border hover:bg-gray-200 grid place-items-center transition">
                                      <svg
                                          viewBox="0 0 24 24"
                                          fill="currentColor"
                                  ...
                                  <PopUpMenu className="flex flex-col gap-3" onClose={() => setPopupOpen(-1)} open={popupOpen === student.id}>
                                      <button onClick={() => navigate("/students/profile/" + student.id)} className="bg-white rounded-xl p-2 border shadow-md">
                                          Открыть
                                      </button>
